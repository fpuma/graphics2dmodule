...
/*
* [fpuma] Adding this method to be called after uninitializing my program to avoid memory leaks.
*/
void freeAllocatedPollyInts()
{
	if (NULL != gfxPrimitivesPolyIntsGlobal)
	{
		free( gfxPrimitivesPolyIntsGlobal );
